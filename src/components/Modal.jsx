...
const Modal = ({ isOpen, onClose, color, children }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-lg p-6 max-w-[550px] w-full relative transition-all duration-1000 outline outline-black/5 m-3 max-h-screen overflow-auto scale-65 md:scale-100">
        <button
          onClick={onClose}
